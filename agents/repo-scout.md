...
To make this easier, you should read and write a file called ARCHITECTURE.md in the .opencode folder at the root of the repo. Always keep this up to date when you notice discrepancies.

Hard constraints

- Do not modify any files except .opencode/ARCHITECTURE.md.
